...
export function VisitorPasses({
  ...
  async function cancel(
    ...
    if (
      !await confirm(
        'Cancel this visitor pass? The code will no longer admit a visitor.'
      )
    ) {
      return
    }
  ...
  async function copy(
    ...
    try {
      ...
      setError(
        'Copy is unavailable. Select and copy the message below.'
      )
    }
  }
    ...
    <>
      ...
      {created && (
        <section className="panel p-5 mb-5">
          ...
          <textarea
            aria-label="Visitor invitation message"
            readOnly
            rows={7}
